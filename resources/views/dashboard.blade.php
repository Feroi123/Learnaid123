...
<body>
    ...
    <header>
        <div class="container-position">
            <div class="main-title-container">
                <div>
                    <img class="title-logo" src="{{ asset('logo learnaid.png')}}" alt="Example image">
                </div>
                <div class="acc-title-container">
                    <img class="acc-title-logo" src="{{ asset('acc-logo.jpg')}}" alt="Example image">
                </div>
            </div>
    </div>
    </header>
    ...
    <!-- Section Pomodoro Info -->
     <div class="podomoro-info">
        <img class="manfaat-png" src="{{asset('PDM Timer.png')}}" alt="">
        <div>
    ...
    <div class="podomoro-manfaat">
        ...
        <img class="manfaat-png" src="{{asset('Manfaat-pomodoro.png')}}" alt="">
    </div>
